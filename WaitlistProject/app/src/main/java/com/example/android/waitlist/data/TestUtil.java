...
public class TestUtil {
    ...
    public static void insertFakeData(SQLiteDatabase db){
        ...
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 12);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_SEX, "Male");
        list.add(cv);
        ...
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 99);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_SEX, "Female");
        list.add(cv);
        ...
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 45);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_SEX, "Female");
        list.add(cv);
